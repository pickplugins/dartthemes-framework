...
if ( ! defined('ABSPATH')) exit;  // if direct access
    ...
    class dartthemes_fw_about_me_Widget extends WP_Widget{

        public function __construct() {
            parent::__construct(
                'dartthemes_fw_about_me', // Base ID
                __('Bug blog - About me', 'dart-framework'), // Name
                array('description' => __('Displaying about me', 'dart-framework'),) // Args
            );
        }
            ...
            <div class="widget-about-me">
                ...
                if(!empty($about_me_data)):
                    ...
                    <div class="item">
                        ...
                        <p>
                            <?php _e('Profile image URL:','dart-framework')?><br>
                        ...
                        <p>
                            <?php _e('Profile descriptions:','dart-framework')?><br>
                    ...
                    <div class="item">
                        <p>
	                        <?php _e('Profile image:','dart-framework')?><br>
                            <input type="text" placeholder="http://website.com/assets/profile.png" value="<?php echo esc_url_raw($profile_src_url); ?>" name="<?php echo esc_attr($this->get_field_name('about_me')); ?>[profile_src_url]">
                        </p>
        ...
        public function widget($args, $instance)
        {
            ...
            $title = apply_filters('widget_title', empty($instance['title']) ? __('About me', 'dart-framework') :
    ...
    // register widgets
    if (!function_exists('dartthemes_fw_about_me_register')) {
        function dartthemes_fw_about_me_register()
        {
            register_widget('dartthemes_fw_about_me_Widget');
        }

       add_action('widgets_init', 'dartthemes_fw_about_me_register');
    }
