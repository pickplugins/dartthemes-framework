...
if ( ! defined('ABSPATH')) exit;  // if direct access
    ...
    class dartthemes_fw_social_Widget extends WP_Widget{

        public function __construct() {
            parent::__construct(
                'dartthemes_fw_social_links', // Base ID
                __('Bug blog - Social Links', 'dart-framework'), // Name
                array('description' => __('Displaying social icons', 'dart-framework'),) // Args
            );
        }
        ...
        public function form($instance) {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title :', 'dart-framework');
                    ?></label>
            ...
            <div class="widget-social-input">
                <div class="add button" name-data="<?php echo esc_attr( $this->get_field_name('social_links') ); ?>"><?php _e('Add', 'dart-framework'); ?></div>
                ...
                foreach ($social_links as $index=>$link_data){
                    ...
                    <div class="item">
                        ...
                        <br>
                        <input class="dartthemes_fw_color" type="text" placeholder="#ffffff" value="<?php echo esc_attr($bg_color); ?>" name="<?php echo esc_attr( $this->get_field_name('social_links') ); ?>[<?php echo esc_attr($index); ?>][bg_color]">
                        <input class="dartthemes_fw_color" type="text" placeholder="#fffff" value="<?php echo esc_attr($color); ?>" name="<?php echo esc_attr( $this->get_field_name('social_links') ); ?>[<?php echo esc_attr($index); ?>][color]">
                    ...
                    <div class="item">
                        ...
                        <input class="dartthemes_fw_color" type="text" placeholder="#fffff" value="" name="<?php echo esc_attr( $this->get_field_name('social_links') ); ?>[<?php echo esc_attr($time); ?>][bg_color]">
                        <input class="dartthemes_fw_color" type="text" placeholder="#fffff" value="" name="<?php echo esc_attr( $this->get_field_name('social_links') ); ?>[<?php echo esc_attr($time); ?>][color]">
                        <span class="remove"><i class="fa fa-times" aria-hidden="true"></i></span>
                        <span class="sort"><i class="fa fa-bars" aria-hidden="true"></i></span>
                    </div>
	                <?php
        ...
        public function widget($args, $instance)
        {
            ...
            $title = apply_filters('widget_title', empty($instance['title']) ? __('Social Icons', 'dart-framework') :
    ...
    // register widgets
    if (!function_exists('dartthemes_fw_social_icon_register')) {
        function dartthemes_fw_social_icon_register()
        {
            register_widget('dartthemes_fw_social_Widget');
        }

       add_action('widgets_init', 'dartthemes_fw_social_icon_register');
    }
