...
if ( ! defined('ABSPATH')) exit;  // if direct access
    ...
    class dartthemes_fw_advertisement_Widget extends WP_Widget{

        public function __construct() {
            parent::__construct(
                'dartthemes_fw_advertisement', // Base ID
                __('Bug blog - Ads Banner', 'dart-framework'), // Name
                array('description' => __('Displaying ads banner', 'dart-framework'),) // Args
            );
        }
        ...
        public function form($instance) {
            ...
            <div id="<?php echo esc_attr($widget_id); ?>" class="widget-advertisement">
                <div class="add button" widget-id="<?php echo esc_attr($widget_id); ?>" name-data="<?php echo esc_attr( $this->get_field_name('advertisement') ); ?>"><?php _e('Add', 'dart-framework'); ?></div>
                ...
                foreach ($advertisement_data as $index=>$link_data){
                   ...
                   //var_dump($link_data);
                    ...
                    <div class="item">
                        ...
                        <p>
                            <?php _e('Banner image url:','dart-framework')?><br>
                        ...
                        <p>
                            <?php _e('Banner target url:','dart-framework')?><br>
        ...
        public function widget($args, $instance)
        {
            ...
            $title = apply_filters('widget_title', empty($instance['title']) ? __('Ads Banner', 'dart-framework') :
    ...
    // register widgets
    if (!function_exists('dartthemes_fw_advertisement_register')) {
        function dartthemes_fw_advertisement_register()
        {
            register_widget('dartthemes_fw_advertisement_Widget');
        }

       add_action('widgets_init', 'dartthemes_fw_advertisement_register');
    }
