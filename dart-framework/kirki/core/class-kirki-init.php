...
class Kirki_Init {
	...
	public static function get_variables() {
		...
		_doing_it_wrong( __METHOD__, esc_attr__( 'We detected you\'re using Kirki_Init::get_variables(). Please use Kirki_Util::get_variables() instead.', 'dart-framework' ), '3.0.10' );
		// Return result using the Kirki_Util class.
