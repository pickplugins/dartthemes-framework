...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected' => esc_attr__( 'No File Selected', 'dart-framework' ),
				'remove'         => esc_attr__( 'Remove', 'dart-framework' ),
				'default'        => esc_attr__( 'Default', 'dart-framework' ),
				'selectFile'     => esc_attr__( 'Select File', 'dart-framework' ),
				'standardFonts'  => esc_attr__( 'Standard Fonts', 'dart-framework' ),
				'googleFonts'    => esc_attr__( 'Google Fonts', 'dart-framework' ),
			)
		);
