...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'dart-framework' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'dart-framework' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'dart-framework' ),
			'200'       => esc_attr__( 'Light 200', 'dart-framework' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'dart-framework' ),
			'300'       => esc_attr__( 'Book 300', 'dart-framework' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'dart-framework' ),
			'400'       => esc_attr__( 'Normal 400', 'dart-framework' ),
			'regular'   => esc_attr__( 'Normal 400', 'dart-framework' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'dart-framework' ),
			'500'       => esc_attr__( 'Medium 500', 'dart-framework' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'dart-framework' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'dart-framework' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'dart-framework' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'dart-framework' ),
			'700'       => esc_attr__( 'Bold 700', 'dart-framework' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'dart-framework' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'dart-framework' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'dart-framework' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'dart-framework' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'dart-framework' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'dart-framework' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'dart-framework' ),
		);
	}
