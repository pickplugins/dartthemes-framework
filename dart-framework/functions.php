...
function dartthemes_fw_setup(){
    ...
    register_nav_menus( array(
        'header-menu' => esc_html__( 'Header Menu', 'dart-framework' ),
        'header-top' => esc_html__( 'Header top', 'dart-framework' ),

        'header-secondary' => esc_html__( 'Header secondary', 'dart-framework' ),
	...
	function dartthemes_fw_comment($comment, $args, $depth){
		...
		switch ( $comment->comment_type ) :
			...
			case 'trackback' :
				...
				<p><?php _e('Pingback:', 'dart-framework'); ?> <?php comment_author_link(); ?> <?php edit_comment_link( __( '(Edit)', 'dart-framework' ), '<span class="edit-link">', '</span>' ); ?></p>
				<?php
				break;
			default :
			...
			<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
				<div id="comment-<?php comment_ID(); ?>" class="comment-body media">
					...
					<div class="comment-context media-body">
						...
						<?php edit_comment_link( __( 'Edit', 'dart-framework' ), '<span class="edit-link comment-meta">', '</span>' ); ?>

						<span class="comment-reply comment-meta">
							<?php comment_reply_link( array_merge( $args, array( 'reply_text' => __( 'Reply', 'dart-framework'
